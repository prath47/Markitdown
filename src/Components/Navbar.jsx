        ...
        <div className='w-full px-4 md:px-8 lg:px-16 py-3 bg-[#4dbfdc] dark:bg-[#274d56] flex items-center justify-between'>
            ...
            <div className='flex items-center justify-center md:gap-2'>
                {route === '/monaco-editor' ?
                    <Link
                        onClick={() => setValue('')}
                        className='hidden md:block text-sm md:text-base text-white bg-green-400 p-2 rounded-md' to={'/simple-editor'}>Try SimpleEditor</Link>
                    : null
                }
                {route === '/simple-editor' ?
                    <Link
                        onClick={() => setValue('')}
                        className='hidden md:block text-sm md:text-base text-white bg-green-400 p-2 rounded-md' to={'/monaco-editor'}>Try MonacoEditor</Link>
                    : null
                }
                ...
                {route === '/monaco-editor' ?
                    <div
                        ...
                        className="cursor-pointer group relative inline-block focus:outline-none focus:ring ml-2 md:ml-4">
                        <span
